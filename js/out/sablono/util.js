...
var len__21393__auto___27496 = arguments.length;
var i__21394__auto___27497 = (0);
while(true){
if((i__21394__auto___27497 < len__21393__auto___27496)){
args__21400__auto__.push((arguments[i__21394__auto___27497]));

var G__27498 = (i__21394__auto___27497 + (1));
i__21394__auto___27497 = G__27498;
continue;
} else {
}
break;
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq27495){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq27495));
});
...
var vec__27502 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var seq__27503 = cljs.core.seq.call(null,vec__27502);
var first__27504 = cljs.core.first.call(null,seq__27503);
var seq__27503__$1 = cljs.core.next.call(null,seq__27503);
var first_word = first__27504;
var words = seq__27503__$1;
...
var G__27506 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__27506,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono.util.camel_case_keys);
} else {
return G__27506;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__27507_SHARP_){
if(typeof p1__27507_SHARP_ === 'string'){
return p1__27507_SHARP_;
} else {
return cljs.core.seq.call(null,p1__27507_SHARP_);
...
//# sourceMappingURL=util.js.map?rel=1519350856325