...
if(((cljs.core.set_QMARK_.call(null,class$)) || (cljs.core.sequential_QMARK_.call(null,class$))) && (cljs.core.every_QMARK_.call(null,(function (p1__27510_SHARP_){
return ((p1__27510_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__27510_SHARP_ === 'string');
}),class$))){
...
return cljs.core.update_in.call(null,G__27512,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__27512;
}
});
...
var len__21393__auto___27515 = arguments.length;
var i__21394__auto___27516 = (0);
while(true){
if((i__21394__auto___27516 < len__21393__auto___27515)){
args__21400__auto__.push((arguments[i__21394__auto___27516]));

var G__27517 = (i__21394__auto___27516 + (1));
i__21394__auto___27516 = G__27517;
continue;
} else {
}
break;
...
var G__27514 = cljs.core.apply.call(null,cljs.core.merge,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__27514,new cljs.core.Keyword(null,"class","class",-2030961996),classes__$1);
} else {
return G__27514;
}
});
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq27513){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq27513));
});
...
var vec__27523 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__27523,(0),null);
var names = cljs.core.nth.call(null,vec__27523,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__27523,tag_name,names){
return (function (p1__27518_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__27518_SHARP_));
});})(matches,vec__27523,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__27523,tag_name,names){
return (function (p1__27519_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__27519_SHARP_));
});})(matches,vec__27523,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__27526){
var vec__27533 = p__27526;
...
var tag = first__27535;
var content = seq__27534__$1;
...
var vec__27536 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__27536,(0),null);
...
//# sourceMappingURL=normalize.js.map?rel=1519350856401